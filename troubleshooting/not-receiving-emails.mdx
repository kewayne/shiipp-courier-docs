...
<Steps>
  <Step title="Check the Email Logs">
    ...
    <AccordionGroup>
      <Accordion icon="check" title="Delivered / Opened">
      ...
      <Accordion icon="triangle-exclamation" title="Failed - Invalid Address">
      ...
      <Accordion icon="server" title="Failed - Authentication / Connection">
      ...
      <Accordion icon="rotate-left" title="Bounced">
      ...
      <Accordion icon="shield-halved" title="Held / Suppression List">
      ...
      <Accordion icon="magnifying-glass" title="Check for existence">
  ...
  <Step title="Verify the Customer's Email Address">
    ...
    <Note>If there's a typo, update their profile immediately to ensure future communications are delivered.</Note>
  </Step>
  ...
  <Step title="Check System Email Configuration">
    ...
    <Warning>Ensure your domain's DNS records (SPF, DKIM, DMARC) are properly configured. Poor DNS configuration can cause major email providers to silently drop your emails.</Warning>
  </Step>
